...
```sh
  cd my-folder
  git clone git@github.com/julzedz/Decode-Morse-Code.git
```
...
- GitHub: [@githubhandle](https://github.com/rashedarman)
- Twitter: [@twitterhandle](https://twitter.com/rashedarman21)
...
- LinkedIn: [LinkedIn](https://www.linkedin.com/in/jules-edozie)
...
Feel free to check the [issues page](https://github.com/julzedz/Decode-Morse-Code/issues).
